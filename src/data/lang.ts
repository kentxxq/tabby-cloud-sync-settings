const CloudSyncLang = {
    lang: {
        common: {
            menu_title: 'Tabby Sync (kentxxq)',
            verifyConfigString: 'This file is generated by Tabby Sync kentxxq Plugin',
            config_inject_header: '/*This file is generated by Tabby Sync kentxxq Plugin - DO NOT MODIFY THIS FILE DIRECTLY OTHERWISE PLUGIN WILL NOT WORK PROPERLY*/\n',
            errors: {
                invalidServerConfig: 'Server contains invalid Tabby settings or empty.'
            }
        },
        form: {
            error: {
